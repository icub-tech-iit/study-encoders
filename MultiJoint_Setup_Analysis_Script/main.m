...
%%
time_interval_array = find(timestamps>=965 & timestamps<=1063.43);
...
text(timestamps(time_interval_array(idx1-400)), my_joint_A.Velocities(time_interval_array(idx1)), ...
...
%%
time_interval_array = find(timestamps>1456 & timestamps<1510.62);
